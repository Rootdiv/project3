...
?>
        <main class="box-small">
          ...
          <div class="photo-block flex-box">
            <div class="photo">
              <div class="photo-box bg-fix flex-box photo-block-mess box size-font" style="background-image: url(<?=PROJECT_URL?>/img/1.jpg); height: 600px;">
            ...
            <div class="photo">
              <div class="photo-box flex-box photo-block-mess box">
                <div>
                  &mdash;&nbsp;&nbsp;&nbsp;<img src="<?=PROJECT_URL?>/img/icons/attention-sign-outline.png" alt="!" />&nbsp;&nbsp;&nbsp;&mdash;
                </div>
              ...
              <div class="photo-box bg-fix flex-box photo-block-mess box size-font" style="background-image: url(<?=PROJECT_URL?>/img/2.jpg);">
            ...
            <div class="photo">
              ...
              <div class="photo-box flex-box photo-block-mess box">
                <div>&mdash;&nbsp;&nbsp;&nbsp;<img src="<?=PROJECT_URL?>/img/icons/attention-sign-outline.png" alt="!" />&nbsp;&nbsp;&nbsp;&mdash;
                </div>
            ...
            <div class="photo">
              ...
              <div class="photo-box bg-fix flex-box photo-block-mess box size-font" style="background-image: url(<?=PROJECT_URL?>/img/4.jpg); height: 600px;">
